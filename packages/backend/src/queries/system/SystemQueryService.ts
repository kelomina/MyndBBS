...
import { PublicRouteWhitelistDTO, RouteWhitelistDTO } from './dto';
...
export class SystemQueryService {
  ...
  public async listPublicRouteWhitelist(): Promise<PublicRouteWhitelistDTO[]> {
    const list = await prisma.routeWhitelist.findMany({
