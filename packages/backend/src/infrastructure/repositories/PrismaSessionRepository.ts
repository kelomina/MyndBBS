...
export class PrismaSessionRepository implements ISessionRepository {
  ...
  public async findActiveByUserAndFingerprint(userId: string, ipAddress: string, userAgent: string): Promise<Session | null> {
  ...
  public async deleteExpiredByUserId(userId: string): Promise<number> {
