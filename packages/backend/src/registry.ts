...
import {
  PrismaTagRepository,
  PrismaPostTagRepository,
} from './infrastructure/repositories/PrismaTagRepository'
...
const T = {
  ...
  IPasswordResetTicketRepository: token<IPasswordResetTicketRepository>(
    'IPasswordResetTicketRepository',
  ),
  ...
  IConversationSettingRepository: token<IConversationSettingRepository>(
    'IConversationSettingRepository',
  ),
  MessagingIdentityIntegrationPort: token<MessagingIdentityIntegrationPort>(
    'MessagingIdentityIntegrationPort',
  ),
  ...
  IInstallationSessionRepository: token<IInstallationSessionRepository>(
    'IInstallationSessionRepository',
  ),
...
function registerServices(): void {
  ...
  container.register(
    T.IUserRepository,
    () => new PrismaUserRepository(container.resolve(T.TotpEncryptionService)),
  )
  ...
  container.register(
    T.IPasswordResetTicketRepository,
  ...
  container.registerSingleton(
    T.ISessionCache,
    () => new RedisSessionCache(container.resolve(T.TotpEncryptionService)),
  )
  container.register(T.ISudoStore, () => new RedisSudoStore())
  container.register(
    T.IUserSecurityReadModel,
    () => new PrismaUserSecurityReadModel(container.resolve(T.TotpEncryptionService)),
  )
  ...
  container.register(
    T.IModeratedWordsCache,
    () => new RedisModeratedWordsCache(new PrismaModeratedWordRepository()),
  )
  container.register(
    T.IModerationPolicy,
    () => new ModerationPolicy(container.resolve(T.IModeratedWordsCache)),
  )
  container.register(
    T.CommunityIdentityIntegrationPort,
    () => new IdentityIntegrationPort(identityQueryService),
  )
  ...
  container.register(
    T.IConversationSettingRepository,
    () => new PrismaConversationSettingRepository(),
  )
  container.register(
    T.MessagingIdentityIntegrationPort,
    () => new IdentityIntegrationPort(identityQueryService),
  )
  ...
  container.register(
    T.IInstallationSessionRepository,
...
function validateRegistrations(): void {
  const requiredTokens: ServiceToken<unknown>[] = [
    ...
    T.IUnitOfWork,
    T.IUserRepository,
    T.IPasskeyRepository,
    T.IAbilityCache,
    T.IPasswordHasher,
    T.ISessionRepository,
    T.IRoleRepository,
    T.IPermissionRepository,
    T.IEmailSender,
    T.ITotpPort,
    T.IPasskeyPort,
    T.ITokenPort,
    ...
    T.IEngagementRepository,
    T.IModerationPolicy,
    T.IModeratedWordsCache,
    T.IBadgeRepository,
    T.IUserBadgeRepository,
    T.IContentReportRepository,
    T.IBannedIpRepository,
    T.ISitePolicyRepository,
    T.IFriendshipRepository,
    T.IPrivateMessageRepository,
    T.IUserKeyRepository,
    T.IConversationSettingRepository,
    T.IAuditLogRepository,
    T.IStoragePort,
    T.IWikiRepository,
    T.IWikiPageRepository,
    T.IWikiCollaboratorRepository,
  ]
...
export const auditEventListener = new AuditEventListener(globalEventBus, auditApplicationService)
...
export const redisModeratedWordsCache = container.resolve<IModeratedWordsCache>(
  T.IModeratedWordsCache,
)
...
export const reportApplicationService = new ReportApplicationService({
  reportRepository: container.resolve(T.IContentReportRepository),
  postRepository: container.resolve(T.IPostRepository),
  commentRepository: container.resolve(T.ICommentRepository),
  eventBus: container.resolve(T.IEventBus),
})
