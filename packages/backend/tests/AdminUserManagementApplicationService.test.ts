...
describe('AdminUserManagementApplicationService', () => {
  it('rejects promoting level > 1 without passkey', async () => {
    ...
    const svc = new AdminUserManagementApplicationService({
      ...
      passkeyRepository: passkeyRepo as any,
      sessionRepository: sessionRepo as any,
      sessionCache: sessionCache as any,
      passwordHasher: { hash: async () => 'hashed', verify: async () => true } as any,
      roleHierarchyPolicy: new RoleHierarchyPolicy(),
      eventBus: eventBus as any,
      unitOfWork: unitOfWork as any,
      abilityCache: { invalidateUserRules: async () => {} } as any,
      emailRegistrationTicketRepository: {} as any,
      passwordResetTicketRepository: {} as any,
      storagePort: {} as any,
    });
