...
jest.mock('../../src/lib/networkSecurity', () => ({
  assertAllowedResolvedHost: jest.fn().mockResolvedValue(undefined),
}));

import nodemailer from 'nodemailer';
import { assertAllowedResolvedHost } from '../../src/lib/networkSecurity';
...
describe('SmtpEmailSender', () => {
  ...
  it('uses SMTP transport when configuration is provided', async () => {
    ...
    expect(assertAllowedResolvedHost).toHaveBeenCalledWith('smtp.example.com');
