...
console.log("can update_status globally:", ability.can('update_status', 'Post'));
console.log("can update_status on cat1:", ability.can('update_status', { __caslSubjectType__: 'Post', id: '1', categoryId: 'cat1' }));
