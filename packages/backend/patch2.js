...
code = code.replace(
  "console.log('Forbidden! user:', req.user, 'rules:', req.ability.rules, 'action:', action, 'subjectType:', subjectType); res.status(403).json({ error: 'Forbidden: Insufficient permissions' });",
