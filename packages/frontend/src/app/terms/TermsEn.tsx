...
export const TermsEn = () => (
  <>
    ...
    <ul>
      <li>Post any content that is illegal, defamatory, harassing, abusive, or obscene.</li>
      <li>Violate the intellectual property rights or privacy rights of others.</li>
      <li>Distribute spam, malware, or engage in any disruptive activity.</li>
      <li>Violate any applicable local, state, national, or international law, including but not limited to the EU General Data Protection Regulation (GDPR) and the Personal Information Protection Law of the PRC (PIPL).</li>
    </ul>

    <h2>5. Intellectual Property</h2>
    <p>By posting content to the Service, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, and display the content in connection with providing the Service. You retain all ownership rights to your content.</p>
    ...
    <p>We may modify these Terms at any time. We will notify you of any material changes by posting the new Terms on the Service. Your continued use of the Service after such modifications constitutes your acceptance of the revised Terms.</p>
  </>
);
