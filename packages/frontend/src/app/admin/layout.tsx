        ...
        <aside className="hidden w-64 flex-col border-r border-border bg-card sm:flex">
          ...
          <nav className="flex-1 space-y-1 px-4 py-4">
            ...
            >
              ...
              <span>{dict.admin?.badgeManagement || 'Badges'}</span>
            </Link>
            <Link
            ...
            {isSuperAdmin && (
              ...
              >
                ...
                <span>
                  {(dict.admin as unknown as { emailConfig?: string }).emailConfig ||
                    'Email Config'}
                </span>
              </Link>
            )}
            ...
            {isSuperAdmin && (
              ...
              >
                ...
                <span>
                  {(dict.admin as unknown as { domainConfig?: string }).domainConfig ||
                    'Domain & Passkey'}
                </span>
              </Link>
            )}
