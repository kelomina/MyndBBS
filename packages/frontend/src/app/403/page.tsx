  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground overflow-hidden relative selection:bg-primary/30">
      ...
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-30 dark:opacity-20">
        <div className="absolute w-[500px] h-[500px] bg-red-500/20 dark:bg-red-500/10 rounded-full blur-[100px] animate-pulse forbidden-pulse-fast"></div>
        <div className="absolute w-[400px] h-[400px] bg-orange-500/20 dark:bg-orange-500/10 rounded-full blur-[80px] animate-pulse forbidden-pulse-slow"></div>
      </div>
